...
import programsPhoto from "../assets/images/programs-every-age.webp"
  ...
  return (
    <section className="bg-brand">
      <div className="mx-auto max-w-[1400px] px-5 py-16 md:px-10 md:py-24">
        ...
        <Link
          to="/workshops"
          className="group relative mt-10 block overflow-hidden rounded-xl border-2 border-ink"
          aria-label="Explore Good Noise workshops"
        >
          <PhotoImage
            src={programsPhoto}
            alt="Three young musicians outdoors, singing together while one holds an acoustic guitar"
