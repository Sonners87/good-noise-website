...
// rendered on. Fixed bg-brand treatment everywhere it's placed so it reads
    ...
    <section className="bg-brand">
      <div className="mx-auto max-w-[1400px] px-5 py-14 md:px-10 md:py-20">
        <div className="flex flex-col items-center gap-6 text-center">
          <p className="font-display max-w-xl text-2xl leading-snug text-white sm:text-3xl">
          ...
          <Link
            to="/stay-in-touch"
            className="font-body font-semibold text-sm text-white/70 underline decoration-2 underline-offset-4 hover:text-white"
          >
            Learn more &rarr;
          </Link>
        </div>
